...
type UpdateTopicRequest struct {
	...
	DataSchema string `protobuf:"bytes,3,opt,name=data_schema,json=dataSchema" json:"data_schema,omitempty"`
}
...
func (m *UpdateTopicRequest) GetDataSchema() string {
	if m != nil {
		return m.DataSchema
	}
	return ""
...
var fileDescriptor0 = []byte{
	...
	,
}
